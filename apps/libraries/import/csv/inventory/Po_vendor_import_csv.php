...
require_once(APPPATH.'libraries/import/utility/inventory/Po_vendor_import.php');
require_once(APPPATH.'libraries/import/csv/inventory/Inventory_base_import_csv.php');
use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Csv;
#[AllowDynamicProperties]
class Po_vendor_import_csv extends Inventory_base_import_csv {
	use  Po_vendor_import;
	...
	public function create_sample_for_import($params=array()){
		...
		$filename=$params['filename'] ?? 'sample_po_vendor_'.date("Y-m-d H:i:s");
		...
		$spreadsheet->getSheet(0)->setTitle("PO Vendors");
