...
$config['auth_library_function'] = 'check_token';
...
|           $config['auth_override_class_method']['accounts']['user'] = 'basic';
						$config['auth_override_class_method']['accounts']['user'] = 'token';
|           $config['auth_override_class_method']['dashboard']['*'] = 'none|digest|basic|token';
|
...
|
*/
$config['rest_keys_table'] = 'wl_apl_tokens';
...
//Default Token to check if keys are enabled but no record in db
$config['default_api_key'] = "MLt!45ai#17xA68";
