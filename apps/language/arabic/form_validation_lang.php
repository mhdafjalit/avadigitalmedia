...
$lang['required']			= "%s is requiredmmm.";
...
$lang['greater_than_equal_to']		= "%s must contain a number greater than or equal to %s.";

$lang['less_than_equal_to']		= "%s must contain a number less than or equal to %s.";
