<div style="min-width:600px;margin:1em auto; font-family:Arial, Helvetica, sans-serif">
	<h1>Invoice</h1>
	<div style="padding:10px 0px;">
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
		<tbody><tr>
			<td align="left"><p style="padding-top:2px; font-size:13px;margin:0px; color:#333; line-height:18px;">
			...
			<td colspan="2" align="left" valign="top">
				<div style="border:2px solid #eee; padding:10px 10px; margin-bottom:10px">
					<div style="margin-top:3px; font:600 12px/20px Arial, Helvetica, sans-serif">
						<b style="float:left; display:block">Invoice No. : <?php echo $ordmaster['invoice_number'];?> <span style="color:#f00;">[ <?php echo $ordmaster['payment_status'];?> ]</span><br>Donated On: <?php echo date("d M, Y",strtotime($ordmaster['order_date']));?></b> 
						<span style="float:right; display:block">Email ID : <?php echo $ordmaster['email'];?><br>Mobile : <?php echo $ordmaster['mobile_number'];?></span>
	...
	<?php if(!empty($params['section'])){
			if($params['section']=='popup'){?>
				<div style="text-align:center; margin:10px 0"><a href="javascript:window.print();"
        style="color:#ff0000; text-decoration:none;font:bold 13px/22px 'Trebuchet MS', Arial, Helvetica, sans-serif; text-transform:uppercase; margin:0px 10px 0 0"><img src="<?php echo theme_url();?>images/prnt.png" border="0" style=" margin-right:3px" alt=""> Print Invoice</a></div>
<?php }
		}
		?>
</div>