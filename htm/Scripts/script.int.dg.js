...
var Path;
if(window.location.origin=='http://127.0.0.1:8888'){Path = "http://127.0.0.1:8888/AUVA-DIGITAL-MEDIA/"}else if(window.location.origin=='https://design.weblink4you.com'){Path = "https://design.weblink4you.com/Auva-Digital-Media/htmLpageS/"}else{Path='http://localhost/auva_digital_media/htm/'}
...
$('.nav_pos').on('click','a.tog_menu',function(){$('#sidebar').toggleClass('slide_menu');if($('#sidebar').hasClass('slide_menu')){$('#main-content').css('margin-left','105px');$('#sidebar ul.acc_links li').addClass('tog_btn')}else{$('#main-content').css('margin-left','60px')}})
