...
<div class="news_box d-sm-flex justify-content-between align-items-start trans_eff">
	...
	<div class="news_cont">
		<p class="news_title overflow-hidden"><a href="<?php echo site_url('members/news/details');?>" class="fw-bold purple">Lorem ipsum dolor sit amet consect adipiscing elit, sed do eiusmod</a></p>
		...
		<a href="<?php echo site_url('members/news/details');?>" title="Learn More" class="text-primary fs-8 text-uppercase fw-semibold mt-2 d-inline-block">Learn More</a>
	</div>
</div>
<?php }?>