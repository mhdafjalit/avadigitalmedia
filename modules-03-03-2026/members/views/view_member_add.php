<?php 
	...
	$bdcm_array = array(
		array('heading'=>'User Manage','url'=>'admin/members'),
				...
				<div class="dash_box p-4">
					...
					<div class="row g-3">
						...
						<div class="col-sm-6 col-lg-4">
							...
							<?php //echo CountrySelectBox(array('name'=>'country','id'=>'country','opt_val_fld'=>'id','format'=>'data-fld-key="country_id" class="form-select" data-next-sel-val="'.(set_value('state')).'"  data-class="ajx_location" data-url="remote/load_states"','current_selected_val'=>set_value('country')));?>
                            <?php echo CountrySelectBox(array('name'=>'country','id'=>'country','opt_val_fld'=>'id','format'=>'data-fld-key="country_id" class="form-select" data-next-sel-val="'.(set_value('state')).'"  data-class="ajx_location" data-url=""','current_selected_val'=>set_value('country')));?>
							<?php echo form_error('country');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label for="State" class="form-label">State </label>
							<?php /*?><select name="state" data-fld-key="state_id" id="state" data-next-sel-val="<?php echo set_value('city');?>"  class="form-select" data-class="ajx_location" data-url="remote/load_cities">
                            <select name="state" data-fld-key="state_id" id="state" data-next-sel-val="<?php echo set_value('city');?>"  class="form-select" data-class="ajx_location">
