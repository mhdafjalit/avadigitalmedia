	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						...
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?php echo site_url('members/release/tracks/'.$releaseId.'?album_type='.$album_type);?>">Tracks</a>
						</li>
						<li class="nav-item">
					...
					<div class="row g-3 mt-1">
						...
						<div class="col-lg-6">
							...
							<input type="radio" class="btn-check" name="content_type" id="Audio" value="0" <?php echo (($content_type==0)? 'checked' : '');?> autocomplete="off">
							<label class="btn btn-sm btn-outline-dark" for="Audio">Audio</label>
							<input type="radio" class="btn-check" name="content_type" id="Video" value="1" <?php echo (($content_type==1)? 'checked' : '');?> autocomplete="off">
							<label class="btn btn-sm btn-outline-dark" for="Video">Video</label>
