	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?php echo site_url('members/release/new_release/'.$releaseId.'?album_type='.$album_type);?>">Release Information</a>
						</li>
						<li class="nav-item">
					...
					<div class="row g-0 mt-3">
						...
						<div class="col-lg-4 ps-lg-3 pe-lg-3 order-1 order-lg-2">
							<div class="dtl_upload_img border-0 text-center">
								...
								<p class="attach_btn mt-4"><a href="javascript:void(0)" class="text-primary fw-bold">Upload Cover Picture</a></p>
