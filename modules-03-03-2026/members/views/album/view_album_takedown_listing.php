                    ...
                    foreach ($res as $key => $val) {
                      ...
                      <tr class="pr_parent" data-label-id="<?php echo $val['release_id'];?>">
                        ...
                        <td class="white_space">
                          ...
                          <a href="<?php echo site_url('members/release/new_release/'.md5($val['release_id']).'?album_type='.$val['album_type']);?>" class="me-2" title="Edit"><img src="<?php echo theme_url();?>images/edit.svg" width="16" decoding="async" fetchpriority="high" alt="Edit"></a>
                          <a href="<?php echo site_url('members/album/album_status/'.md5($val['release_id']).'?al_status=restore')?>" class="btn btn-sm btn-dark">Restore</a>
                          <?php
