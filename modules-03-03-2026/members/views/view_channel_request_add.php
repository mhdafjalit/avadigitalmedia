    ...
    <div id="main-content" class="h-100">
      ...
      <div class="main-content-inner">
        <div class="dash_box p-4">
          ...
          <div class="mb-4"> 
            <a href="javaScript:void(0)" class="btn btn-outline-dark active">Channel Add Request</a>  
            <a href="<?php echo base_url();?>members/channel_white_list_request" class="btn btn-outline-dark ">Channel White List Request</a>  
            <a href="<?php echo base_url();?>members/claim_release_request" class="btn btn-outline-dark ">Claim Release Request</a>
          </div>
