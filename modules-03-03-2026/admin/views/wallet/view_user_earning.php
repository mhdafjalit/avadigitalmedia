        ...
        <div id="main-content" class="h-100">
            ...
            <div class="main-content-inner">
                <ul class="nav nav-underline tabber_style">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo site_url('admin/wallet/user_earning');?>">User Earning Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url('admin/wallet/commission');?>">Commission Amount</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo site_url('admin/wallet/revenue_graph');?>">Revenue Graph</a>
                    </li>
                </ul>
