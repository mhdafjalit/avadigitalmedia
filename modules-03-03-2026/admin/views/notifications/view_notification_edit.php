...
<div class="p-3">
	...
	<div class="mb-2">
		...
		<input type="text" name="notification_title" id="notification_title" class="form-control" value="<?php echo set_value('notification_title',$res['notification_title']);?>">
		<?php echo form_error('notification_title');?>
	</div>
	<div class="mb-2">
		<label for="description" class="form-label">Description *</label>
		<textarea id="description" class="form-control" name="description" rows="6"><?php echo set_value('description',$res['description']);?></textarea>
		<?php echo form_error('description');?>
	</div>
	<div class="text-center">
		<input type="hidden" name="action" value="Y">
		<input name="submit" type="submit" class="btn btn-purple" value="Edit">
	</div>
	<?php echo form_close();?>
</div>
</body>
