					...
					foreach ($album_types as $key => $val) {
						echo '<div class="tab-pane fade '.(($key==1)? ' show active':'').'" id="pills-'.$key.'" role="tabpanel" aria-labelledby="pills-'.$key.'-tab" tabindex="0">
							<div id="owl-'.(($key==1)? 'music':'video').'" class="owl-carousel owl-theme mt-2 scroll_arr">
								<div class="item">';
								?>
									<div class="count_box count_graph1 position-relative overflow-hidden hand trans_eff" onClick="window.open('<?php echo site_url('admin/metas');?>','_self')">
                                    <?php
									
										echo '<p class="count_title purple fw-bold mb-1">Created Album</p>
										<div class="d-flex">
								...
								<div class="item">
									<div class="count_box count_graph1 position-relative overflow-hidden hand trans_eff disabled" style="pointer-events:none;" onClick="window.open(\''.site_url('admin/album/rejected_album').'?album_type='.$key.'\',\'_parent\')">
								...
								<div class="item">
									<div class="count_box count_graph2 position-relative overflow-hidden hand trans_eff disabled" style="pointer-events:none;" onClick="window.open(\''.site_url('admin/album/takedown_album').'?album_type='.$key.'\',\'_parent\')">
