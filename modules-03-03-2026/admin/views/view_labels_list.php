...
<div class="d-flex">
              <input type="text" name="keyword" class="form-control fs-7 w-100" value="<?php echo $posted_keyword;?>" placeholder="Search by title, Added by">
              <input type="submit" class="btn btn-sm btn-purple ms-2" value="Search">
              <?php
              if( $posted_keyword!='') {
              echo '<a href="'.site_url('admin/labels').'" class="btn btn-sm btn-outline-danger"><b>Clear</b></a>';
              }?>
            </div>
            </div>
           
            <div class="col-8 col-sm-4 mt-1">Show Entries 
              <?php echo front_record_per_page('per_page','per_page');?>
            </div>
            <div class="col-4 col-sm-2 text-end">
              <a href="<?php echo site_url('admin/add_label');?>" class="btn btn-purple">Add Label</a>
            </div>
          </div>
          <?php echo form_close();?>
        </div>
                    ...
                    foreach ($res as $key => $val) {
                      ...
                      <tr class="pr_parent" data-label-id="<?php echo $val['label_id'];?>">
                        ...
                        <td>
                          ...
                          <p class="mt-1"><?php echo $val['channel_url'];?></p><hr>
                          <b>Added By :</b> <?php echo $val['first_name'];?><br>
                          <b>Added On :</b> <?php echo getDateFormat($val['created_date'],1);?>
                        </td>
                        <td>
                          <p><?php echo $val['email'];?></p>
                          <p class="mt-1"><?php echo $val['first_name'];?></p>
                        </td>
                        ...
                        <td class="text-<?php echo ($val['status']=='1')? 'success':'danger';?>">
                            ...
                            <div class="d-flex flex-wrap align-items-center add_status mb-2">
                              ...
                              <div id="err_status_<?php echo $val['label_id'];?>" class="required"></div>
                              <input type="text" name="reason" class="form-control fs-7 lreason dn" placeholder="Enter Reason">
                              <div id="err_reason_<?php echo $val['label_id'];?>" class="required"></div>
                              </div>
                              <input type="button" value="Submit" class="btn btn-sm btn-primary mt-1 btn_sbt">
                              <div class="text-success msg" id="msg_<?php echo $val['label_id'];?>"></div>
                            </div>
                            <?php 
                            }
                        ...
                        <td class="text-nowrap">
                          ...
                          <a href="<?php echo site_url("admin/edit_label/".md5($val['label_id']));?>" class="me-2" title="Edit">
                            <img src="<?php echo theme_url();?>images/edit.svg" width="15" alt="Edit">
                          </a> 
                          
                          <a href="<?php echo site_url("admin/label_delete/".md5($val['label_id']));?>" class="me-2 confirm_delete" title="Delete">
