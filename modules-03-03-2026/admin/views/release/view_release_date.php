...
{
	$main_release_date	= set_value('main_release_date',$res['main_release_date']);
}
else
{
  	$main_release_date = set_value('main_release_date');
}
?>
	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						...
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?php echo site_url('admin/release/date_release/'.$releaseId.'?album_type='.$album_type);?>">Release Date</a>
						</li>
						<li class="nav-item">
					...
					<?php
			       	echo error_message();
			       	echo form_open(current_url_query_string(),'id="add_release_date" role="form"');
					?>
					<div class="row g-3 mt-3">
						<div class="col-sm-6">
							<label class="form-label">Choose a Main Release Date * <img src="<?php echo theme_url();?>images/que.svg" alt="" data-bs-toggle="tooltip" data-bs-placement="top" title="Lorem ipsum dolor sit amet consectetur adipiscing elit"></label>
							<input type="text" name="main_release_date" class="form-control release_date1" value="<?php echo $main_release_date;?>">
							<?php echo form_error('main_release_date');?>
						</div>
                        <?php /*
                        <div class="col-sm-6">
