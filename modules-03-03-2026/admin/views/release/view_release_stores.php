	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						...
						<li class="nav-item">
							<a class="nav-link active" href="<?php echo site_url('admin/release/stores/'.$releaseId.'?album_type='.$album_type);?>">Stores</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" aria-current="page" href="<?php echo site_url('admin/release/territories/'.$releaseId.'?album_type='.$album_type);?>">Territories</a>
						</li>
						<li class="nav-item">
				...
				<div class="dash_box mt-3 overflow-hidden ref_root_ckbox_parent">
					...
					<div class="p-4">
						<div class="row gx-0 gy-2">
							<?php
							if(is_array($res_stores) && !empty($res_stores)){
