                    ...
                    foreach ($res as $key => $val) {
                      ...
                      <tr class="pr_parent" data-release-id="<?php echo $val['release_id'];?>">
                        ...
                        <td class="white_space">
                          ...
                          <a href="<?php echo site_url('admin/release/new_release/'.md5($val['release_id']).'?album_type='.$val['album_type']);?>" class="me-2" title="Edit"><img src="<?php echo theme_url();?>images/edit.svg" width="16" decoding="async" fetchpriority="high" alt="Edit"></a>
                          <a href="<?php echo site_url("admin/album/release_delete/".md5($val['release_id']));?>" class="me-2 confirm_delete" title="Delete">
                          ...
                          if($val['status']!='1'){?>
                            <div class="align-items-center add_status mb-1 mt-2">
                              ...
                              <div id="err_status_<?php echo $val['release_id'];?>" class="required"></div>
                              <input type="text" name="reason" class="form-control fs-7 lreason dn" placeholder="Enter Reason">
                              <div id="err_reason_<?php echo $val['release_id'];?>" class="required"></div>
                              </div>
                              <input type="button" value="Submit" class="btn btn-sm btn-primary mt-1 btn_sbt">
                              <div class="text-success msg" id="msg_<?php echo $val['release_id'];?>"></div>
                            </div>
                            <?php 
                          }
