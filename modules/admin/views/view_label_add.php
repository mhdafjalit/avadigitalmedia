<?php 
	...
	$bdcm_array = array(
		array('heading'=>'Manage Labels','url'=>'admin/labels'),
				...
				<div class="dash_box p-4">
					...
					<div class="row g-3">
						<div class="col-sm-6 col-lg-4">
							...
							<input type="text" class="form-control" name="channel_name" id="channel_name" value="<?php echo set_value('channel_name');?>">
							<?php echo form_error('channel_name');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label for="channel_url" class="form-label">Channel URL *</label>
							<input type="text" class="form-control" name="channel_url" id="channel_url" value="<?php echo set_value('channel_url');?>">
						...
						<div class="col-sm-6 col-lg-4">
							...
							<input type="text" class="form-control" name="user_rate" id="user_rate" value="<?php echo set_value('user_rate');?>">
						...
						<div class="col-12">
							...
							<div class="row g-0 mt-2">
								<div class="col-6 col-sm-4 pe-1">
									<small>From: *</small> 
									<input name="agreement_from" id="agreement_from" type="text" class="form-control start_date1" value="<?php echo set_value('agreement_from');?>" placeholder="yyyy-mm-dd" readonly="readonly">
									<?php echo form_error('agreement_from');?>
								</div>
								<div class="col-6 col-sm-4 ps-1">
									<small>To: *</small> 
									<input name="agreement_to" id="agreement_to" type="text" class="form-control end_date1" value="<?php echo set_value('agreement_to');?>" placeholder="yyyy-mm-dd" readonly="readonly">
