        ...
        <div class="bg-white p-2 mb-2 rounded-3">
          ...
          <div class="row g-0">
            ...
            <div class="d-flex">
              ...
              <input type="submit" class="btn btn-sm btn-purple ms-2" value="Search"> <?php
            ...
            <div class="col-5 col-sm-2 text-end">
              <a href="<?php echo site_url('admin/create_sub_admin');?>" class="btn btn-purple">Add User</a>
            </div>
          </div>
          <?php echo form_close();?>
        </div>
        <?php echo form_open("",'id="data_form"');?>
       Notification Select: <select name="notification_id" id="notification_id" class="bg-light border ms-1 rounded-2 p-1" required>
                  ...
                  if(is_array($res) && !empty($res)){
                    ...
                    foreach ($res as $key => $val) {
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if($val['status']=='0'){?>
                          <a href="<?php echo site_url('admin/status_sub_admin/'.md5($val['customers_id']).'?u_status=active')?>" class="btn btn-sm btn-danger me-3" title="Click Here to Activate">Deactivate</a>
                          <?php }else{ ?>
                            <a href="<?php echo site_url('admin/status_sub_admin/'.md5($val['customers_id']).'?u_status=deactive')?>" class="btn btn-sm btn-primary" title="Click Here to Deactivate">Activate</a>
                          <?php } ?>
                        </td>
                        <td class="white_space">
                          ...
                          <a href="<?php echo site_url("admin/edit_sub_admin/".md5($val['customers_id']));?>" class="me-2" title="Edit">
                            <img src="<?php echo theme_url();?>images/edit.svg" width="15" alt="Edit">
                          </a>
                          <a href="<?php echo site_url("admin/delete_sub_admin/".md5($val['customers_id']));?>" class="me-2 confirm_delete" title="Delete">
                            <img src="<?php echo theme_url();?>images/delete.svg" width="19" alt="Delete">
                          </a>
                          <p class="mt-3 fw-bold">Permission</p>
                          <p class="mt-1">
                            <a href="<?php echo site_url('admin/permission_add/'.md5($val['customers_id']));?>" class="btn btn-sm btn-dark">Add</a> 
                            <a href="<?php echo site_url('admin/permission/'.md5($val['customers_id']));?>" class="btn btn-sm btn-dark pop3" data-type="iframe">View</a>
                          </p>
                        </td>
                      </tr>
