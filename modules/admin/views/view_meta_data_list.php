                  ...
                  if(is_array($res) && !empty($res)){
                    foreach ($res as $key => $val) {
                      ...
                      <tr>
                        <td><?php echo $i;?></td>
                        <td>
                          <?= getdateFormat($val['metadata_from'],1);?> -  
                          <?= getdateFormat($val['metadata_to'],1);?>
                        </td>
                        ...
                        <?php 
						            if($hasData){ ?>
                        	<a href="<?= site_url('admin/export_signed_albums/'.md5($val['md_id'])); ?>" class="" title="Export to Excel"><img src="<?= theme_url();?>images/download.svg" width="19" alt="Export Excel" class="hand">
                        </a>
                    	 <?php 
            						}else{?>
                        ...
                        <td>
                          <a href="<?= site_url("admin/meta_delete/".md5($val['md_id']));?>" class="me-2 confirm_delete" title="Delete">
