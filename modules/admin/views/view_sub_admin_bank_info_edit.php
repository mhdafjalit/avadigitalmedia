    	...
    	<div class="main-content-inner">
    		<div class="dash_box p-4">
    			<ul class="nav nav-underline tabber_style">
				  <li class="nav-item">
				  	<a class="nav-link" aria-current="page" href="<?php echo site_url('admin/edit_sub_admin/'.$uerId);?>">Profile Setting</a>
				  </li>
				  <li class="nav-item">
				  	<a class="nav-link active" href="<?php echo site_url('admin/edit_bank_info/'.$uerId);?>">Tax & Bank Info</a>
				  </li>
				  <li class="nav-item">
