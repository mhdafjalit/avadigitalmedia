            ...
            <div class="bg-white p-3 mb-3 rounded-3">
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     ...
                     <a href="<?php echo site_url('admin/settingcontroller/list_role');?>" class="btn btn-danger w-100">
                     Clear
                     </a>
                     <?php } ?>
                  </div>
                  ...
                  <table class="table table-bordered table-striped">
                     <thead>
                        <tr>
                           <th width="60">Sr</th>
                           <th>Role Name</th>
                           <th> By System Created / By User Created
                        ...
                        <tr>
                           ...
                           <td>
                              <?php 
                                 ...
                                 if(in_array($val['role_id'], $system_role_ids)){
                                     echo '<span class="badge bg-purple" style="background:purple">System Role</span>';
                                 }else{
                                     echo '<span class="badge bg-success">Custom Role</span>';
                                 }
                                 ?>
                           </td>
                           <td>
                           ...
                           <td class="action_icon">
                              ...
                              &nbsp;&nbsp;
                              <a href="javascript:void(0)"
                                 data-url="<?php echo site_url("admin/settingcontroller/delete_role/".md5($val['role_id']));?>"
                                 class="delete_role">
...
<div class="modal fade" id="editRoleModal">
   <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
         ...
         <form method="post" action="<?php echo site_url('admin/settingcontroller/update_role');?>">
...
<div class="modal fade" id="addRoleModal">
   <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
         ...
         <form method="post" action="<?php echo site_url('admin/settingcontroller/create_role');?>">
            <input type="hidden"
               name="<?php echo $this->security->get_csrf_token_name();?>"
               value="<?php echo $this->security->get_csrf_hash();?>">
            <div class="modal-body p-4">
...
<script>
   ...
   url:"<?php echo site_url('admin/settingcontroller/edit_role/');?>"+id,
   type:"GET",
   dataType:"json",
...
<script>
   ...
   var url="<?php echo site_url('admin/settingcontroller/status_role/');?>"+id+"?u_status="+status;
