...
<a href="<?php echo site_url('admin/list_department');?>" class="btn btn-danger w-100">
Clear
</a>
...
<a href="javascript:void(0)"
data-url="<?php echo site_url("admin/delete_department/".md5($val['department_id']));?>"
...
<form method="post" action="<?php echo site_url('admin/create_department');?>">
...
<form method="post" action="<?php echo site_url('admin/update_department');?>">
...
url : "<?php echo site_url('admin/edit_department/');?>"+id,
type: "GET",
dataType: "json",
...
var url = "<?php echo site_url('admin/status_department/');?>"+id+"?u_status="+status;
