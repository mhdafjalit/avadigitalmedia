...
<div class="top_sec d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <a href="<?php echo site_url('admin/export_countries');?>" class="btn-modern btn-outline-modern me-2" title="Export Countries">
            <i class="bi bi-file-earmark-spreadsheet"></i> Export Countries
        </a>
        <a href="<?php echo site_url('admin/export_states');?>" class="btn-modern btn-outline-modern me-2" title="Export States">
            <i class="bi bi-file-earmark-spreadsheet"></i> Export States
        </a>
        <a href="<?php echo site_url('admin/export_cities');?>" class="btn-modern btn-outline-modern" title="Export Cities">
            ...
            <div>
                ...
                <div class="header-badge">
                    ...
                    <?php if(isset($countries) && isset($total_countries) && count($countries) < $total_countries){ ?>
                        ...
                        <?php echo $this->uri->segment(3) ? ($this->uri->segment(3)/24)+1 : 1; ?>)</small>
                    <?php } ?>
                </div>
            </div>
        </div>
        ...
        <?php if(isset($country_pagination)){ ?>
            <div class="mt-3 d-flex justify-content-between align-items-center flex-wrap">
                <div class="text-muted mb-2 mb-md-0">
                    ...
                    (Page <strong><?php echo $this->uri->segment(3) ? ($this->uri->segment(3)/24)+1 : 1; ?></strong> 
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-icons">
                                    ...
                                    <a href="javascript:void(0)" class="action-icon delete delete_btn" data-url="<?php echo site_url('admin/delete_state/'.$s['id']);?>" title="Delete">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-icons">
                                    ...
                                    <a href="javascript:void(0)" class="action-icon delete delete_btn" data-url="<?php echo site_url('admin/delete_city/'.$ci['id']);?>" title="Delete">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                </div>
                            </td>
...
<div class="modal fade modern-modal" id="addCountryModal">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/create_country');?>" id="addCountryForm">
...
<div class="modal fade modern-modal" id="editCountryModal">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/update_country');?>" id="editCountryForm">
...
<div class="modal fade modern-modal" id="addStateModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/create_state');?>" id="addStateForm">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                <div class="modal-body-modern">
                    <div class="mb-3">
...
<div class="modal fade modern-modal" id="editStateModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/update_state');?>" id="editStateForm">
...
<div class="modal fade modern-modal" id="addCityModal">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/create_city');?>" id="addCityForm">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                <div class="modal-body-modern">
                    <div class="row">
                        <div class="col-md-6 mb-3">
...
<div class="modal fade modern-modal" id="editCityModal">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('admin/update_city');?>" id="editCityForm">
...
function loadStates(country_id, target_element_id) {
    ...
    $.ajax({
        url: '<?php echo site_url('admin/get_states_by_country');?>/'+country_id,
        type: 'GET',
        dataType: 'json',
...
$(document).ready(function(){
    ...
    $(document).on("click",".toggle_featured",function(){
        var id = $(this).data("id");
        var url = "<?php echo site_url('admin/toggle_featured_country/');?>"+id;
    ...
    $(document).on("click",".toggle_popular",function(){
        var id = $(this).data("id");
        var url = "<?php echo site_url('admin/toggle_popular_state/');?>"+id;
    ...
    $(document).on("click",".toggle_premium",function(){
        var id = $(this).data("id");
        var url = "<?php echo site_url('admin/toggle_premium_city/');?>"+id;
    ...
    $(document).on("click",".toggle_city_popular",function(){
        var id = $(this).data("id");
        var url = "<?php echo site_url('admin/toggle_popular_city/');?>"+id;
    ...
    $(document).on("change",".status_toggle",function(){
        ...
        var url = "<?php echo site_url('admin/status_location/');?>"+type+"/"+id+"?u_status="+status;
        var checkbox = $(this);
    ...
    $(".edit_country").click(function(){
        var id = $(this).data("id");
        $.ajax({
            url: "<?php echo site_url('admin/edit_country/');?>"+id,
            type: "GET",
            dataType: "json",
            success: function(data){
    ...
    $(".edit_state").click(function(){
        var id = $(this).data("id");
        $.ajax({
            url: "<?php echo site_url('admin/edit_state/');?>"+id,
            type: "GET",
            dataType: "json",
            success: function(data){
    ...
    $(".edit_city").click(function(){
        var id = $(this).data("id");
        $.ajax({
            url: "<?php echo site_url('admin/edit_city/');?>"+id,
            type: "GET",
            dataType: "json",
            success: function(data){
