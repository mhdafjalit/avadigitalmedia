                ...
                <tbody>
                  ...
                  if(is_array($res) && !empty($res)){
                    ...
                    foreach ($res as $key => $val) {
                      ...
                      if($this->mres['member_type']=='1'){?>
                        <tr>
                          <td colspan="10"><input name="Send" type="submit"  value="Send Notification" class="btn btn-sm btn-dark" id="Activate" onClick="return validcheckstatus('arr_ids[]','Send Notification','Record','u_status_arr[]');"/></td>
                        </tr>
                        <?php 
                      }
                    }
