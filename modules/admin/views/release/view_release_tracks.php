...
<div class="dash_outer">
	<div class="dash_container">
	    ...
	    <div id="main-content" class="h-100">
	    	...
	    	<div id="topMusicPlayer" class="top-music-player d-none">

    <div class="player-left">
        <i class="fa fa-music"></i>
        <span id="trackTitle">Audio Preview</span>
    </div>
...
<div class="audio-card text-center">
...
<i class="fa-solid fa-music"></i>
    ...
    <!-- Mini Audio Player -->
    <audio id="audioPreview" class="w-100 mt-2 d-none" controls>
...
<div class="audio-card text-center text-muted">
    <i class="fa fa-music fa-2x"></i>
    <div class="small mt-1">No Audio</div>
</div>

<?php endif; ?>

<label class="form-label mt-2">Audio Preview</label>
...
$("#progressBar").on("input",function(){
    ...
    let seek = audio.duration * ($(this).val()/100);
...
$(function(){
  	$('input[name="is_isrc"]').change(function(){
	    if($(this).val() == 1){
	      	...
	      	$.post("<?= base_url('remote/auto_generate_isrc'); ?>", postData, function(res){
