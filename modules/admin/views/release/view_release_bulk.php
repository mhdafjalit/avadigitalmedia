				...
				<div class="bulk_uplod_w mt-4 text-center">
					...
					<div class="row g-3">
						<div class="col-sm-4">
							...
							<a href="<?php echo site_url('admin/release/download_labels');?>" class="btn btn-primary btn-sm d-inline-block"><img src="<?php echo theme_url();?>images/download2.svg" width="15" alt="Download"> Download</a>
						</div>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							...
							<a href="<?php echo site_url('admin/release/download_territories');?>" class="btn btn-primary btn-sm d-inline-block"><img src="<?php echo theme_url();?>images/download2.svg" width="15" alt="Download"> Download</a>
						</div>
						<div class="col-sm-4">
							<p class="mt-3">Download Release Excel Template</p>
							<a href="<?php echo site_url('admin/release/download_release_format?album_type='.$album_type);?>" class="btn btn-primary btn-sm d-inline-block"><img src="<?php echo theme_url();?>images/download2.svg" width="15" alt="Download"> Download</a>
						</div>
					</div>
