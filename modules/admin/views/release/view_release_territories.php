	    ...
	    <div id="main-content" class="h-100">
	    	...
	    	<div class="main-content-inner">
				...
				<div class="mt-3 mb-3 text-center">
					...
					<input type="button" name="button" class="btn btn-dark text-white text-uppercase" value="Skip" onclick="window.open('<?= site_url('admin/release/date_release/'.$releaseId.'?album_type='.$album_type);?>','_parent')">
				</div>
				<?php echo form_close(); ?>
			</div>
