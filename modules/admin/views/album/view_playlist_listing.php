        ...
        <div class="bg-white p-2 mb-2 rounded-3">
          ...
          <div class="row g-0">
            ...
            <div class="col-3 col-sm-3 mt-1">
              ...
              <?php
              if( $posted_keyword!='') {
              echo '<a href="'.site_url('admin/album/playlists').'" class="btn btn-sm btn-outline-danger"><b>Clear</b></a>';
              }?>
            </div>
                  ...
                  if(is_array($res) && !empty($res)){
                    foreach ($res as $key => $val) {
                      ...
                      <tr class="pr_parent" data-label-id="<?php echo $val['id'];?>">
                        ...
                        <td>
                          <a href="<?php echo site_url("admin/album/playlist_delete/".md5($val['id']));?>" class="me-2 confirm_delete" title="Delete">
