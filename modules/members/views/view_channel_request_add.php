      ...
      <div class="main-content-inner">
        <div class="dash_box p-4">
          ...
          <div class="mb-4"> 
            ...
            <a href="<?= site_url('members/channel_white_list_request');?>" class="btn btn-outline-dark ">Channel White List Request</a>  
                    ...
                    foreach ($res as $key => $val) {
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap">
                          <a href="<?= site_url("members/channel_request_delete/".md5($val['request_id']));?>" class="me-2 confirm_delete" title="Delete">
