	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						...
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?php echo site_url('members/release/territories/'.$releaseId.'?album_type='.$album_type);?>">Territories</a>
						</li>
						<li class="nav-item">
				...
				<div class="mt-3 mb-3 text-center">
					...
					<input type="button" name="button" class="btn btn-dark text-white text-uppercase" value="Skip" onclick="window.open('<?= site_url('members/release/date_release/'.$releaseId.'?album_type='.$album_type);?>','_parent')">
				</div>
				<?php echo form_close(); ?>
			</div>
