	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						...
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?php echo site_url('members/release/upload_release/'.$releaseId.'?album_type='.$album_type);?>">Upload</a>
						</li>
						<li class="nav-item">
						...
						<div class="row g-3">
							<div class="col-sm-6">
								...
								if($res['release_song']!='' && file_exists(UPLOAD_DIR.'/release/songs/'.$res['release_song'])){?>
					              	<p class="mt-2"><a href="<?= base_url().'uploaded_files/release/songs/'.$res['release_song'];?>" class="text-primary me-2 b" title="Click to download" download> View</a> | 
