	    	...
	    	<div class="main-content-inner">
				<div class="dash_box p-4">
					<ul class="nav nav-underline tabber_style">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="<?= site_url('members/release/new_release/'.$releaseId.'?album_type='.$album_type);?>">Release Information</a>
						</li>
						<li class="nav-item">
        ...
        if(is_array($artists) && !empty($artists)){
            ...
            <?php 
					...
					<div class="row g-3 mt-3">
						...
						<div class="col-sm-6 col-lg-4">
							<label class="form-label">Label Name * &nbsp;&nbsp; <a href="<?= site_url('members/add_label');?>" title="you can add more labels from here"><span class="badge text-bg-primary">Add Label</span></a></label>
