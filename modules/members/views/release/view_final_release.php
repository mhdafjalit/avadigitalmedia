		...
		<div class="dash_box p-4">
			...
			<div class="mt-4 d-flex">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<b class="fs-7 fw-semibold">Production Year </b>
							<p class="mb-2"><?= $res['production_year'] ?? 'NA';?></p>
						</div>
						<div class="col-sm-6">
			...
			<div class="mt-3 border rounded-3">
				...
				<div class="p-3">
					<div class="row gx-0 gy-3">
						...
						<div class="col-sm-4">
							<b class="fs-7 fw-semibold">Lyrics Language</b>
			...
			<div class="mt-5 fin_box text-white rounded-3 p-4">
				...
				<div class="share_w d-inline-block bg-white p-1 rounded-3">
					...
					<img src="<?= theme_url();?>images/facebook-f.svg" width="18" height="18" title="" alt="" decoding="async" fetchpriority="low" loading="lazy"> </button>
					<button class="share-to btn btn_in" data-with="linkedin">
					<img src="<?= theme_url();?>images/linkedin-in.svg" width="18" height="18" title="" alt="" decoding="async" fetchpriority="low" loading="lazy"> </button>
					<button class="share-to btn btn_insta" data-with="instagram">
					<img src="<?= theme_url();?>images/instagram.svg" width="18" height="18" title="" alt="" decoding="async" fetchpriority="low" loading="lazy"> </button>
					<button class="share-to btn btn_whts" data-with="whatsapp">
					<img src="<?= theme_url();?>images/whatsap.svg" width="18" height="18" title="" alt="" decoding="async" fetchpriority="low" loading="lazy"> </button>
				</div>
			</div>
		</div>
	</div>
