...
$bank_account_type = set_value('bank_account_type',$this->mres['bank_account_type']); 
$bank_service_provider = set_value('bank_service_provider',$this->mres['bank_service_provider']); 
?>
    	...
    	<div class="main-content-inner">
    		<div class="dash_box p-4">
    			<ul class="nav nav-underline tabber_style">
				  <li class="nav-item">
				  	<a class="nav-link" aria-current="page" href="<?php echo site_url('members/edit_account');?>">Profile Setting</a>
				  </li>
				  <li class="nav-item">
				  	<a class="nav-link active" href="<?php echo site_url('members/edit_bank_info');?>">Tax & Bank Info</a>
				  </li>
				  <li class="nav-item">
				...
				$is_gst = set_value('is_gst',$this->mres['is_gst']);
				?>
				<div class="row g-3 mt-3">
					...
					<div class="col-sm-6 col-lg-4 gst <?php echo ($is_gst==1)? '' : ' dn';?>">
						...
						<input type="text" class="form-control" name="gst_number" id="gst_number" value="<?php echo set_value('gst_number',$this->mres['gst_number']);?>">
						<?php echo form_error('gst_number');?>
					</div>

					<div class="col-sm-6 col-lg-4">
						<label for="pan_number" class="form-label">PAN Number *</label>
						<input type="text" class="form-control" name="pan_number" id="pan_number" value="<?php echo set_value('pan_number',$this->mres['pan_number']);?>">
				...
				<div class="form_box form_1 mt-3 <?php echo ($bank_account_type=='1') ? 'dn' : '';?>">
					<div class="row g-3">
						<div class="col-sm-6 col-lg-4">
							...
							<input type="text" name="bank_name" class="form-control" id="bank_name" value="<?php echo set_value("bank_name",$this->mres['bank_name']);?>">
								<?php echo form_error('bank_name');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label  class="form-label">Account Number *</label>
							<input type="text" name="account_no" class="form-control" id="account_no" value="<?php echo set_value("account_no",$this->mres['account_no']);?>">
							<?php echo form_error('account_no');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label class="form-label">IFSC Code *</label>
							<input type="text" name="ifsc_code" class="form-control" id="ifsc_code" value="<?php echo set_value("ifsc_code",$this->mres['ifsc_code']);?>">
							<?php echo form_error('ifsc_code');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label class="form-label">Account Holder Name *</label>
							<input type="text" class="form-control" name="ac_holder_name" id="ac_holder_name" value="<?php echo set_value("ac_holder_name",$this->mres['ac_holder_name']);?>">
							<?php echo form_error('ac_holder_name');?>
						</div>
						<div class="col-sm-6 col-lg-8">
							<label class="form-label">Branch Address *</label>
							<input type="text" class="form-control" name="bank_address" id="bank_address" value="<?php echo set_value("bank_address",$this->mres['bank_address']);?>">
				...
				<div class="form_box form_2 mt-3 <?php echo ($bank_account_type=='1') ? '' : 'dn';?>">
					<div class="row g-3">
						...
						<div class="col-sm-6 col-lg-4">
							...
							<input type="text" class="form-control" name="bank_email" id="bank_email" value="<?php echo set_value('bank_email',$this->mres['bank_email']);?>">
							<?php echo form_error('bank_email');?>
						</div>
						<div class="col-sm-6 col-lg-4">
							<label class="form-label">Bank Customer Id *</label>
							<input type="text" class="form-control" name="bank_customer_id" id="bank_customer_id" value="<?php echo set_value('bank_customer_id',$this->mres['bank_customer_id']);?>">
