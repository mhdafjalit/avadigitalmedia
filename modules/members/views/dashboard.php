					...
					foreach ($album_types as $key => $val) {
						echo '<div class="tab-pane fade '.(($key==1)? ' show active':'').'" id="pills-'.$key.'" role="tabpanel" aria-labelledby="pills-'.$key.'-tab" tabindex="0">
							<div id="owl-'.(($key==1)? 'music':'video').'" class="owl-carousel owl-theme mt-2 scroll_arr">
								<div class="item">
								<div class="count_box count_graph1 position-relative overflow-hidden hand trans_eff" onClick="window.open(\''.site_url('members/album').'?album_type='.$key.'\',\'_parent\')">
								...
								<div class="item">
								<div class="count_box count_graph2 position-relative overflow-hidden hand trans_eff" onClick="window.open(\''.site_url('members/album/album_processing').'?album_type='.$key.'\',\'_parent\')">
								...
								<div class="item">
								<div class="count_box count_graph3 position-relative overflow-hidden hand trans_eff" onClick="window.open(\''.site_url('members/album/final_album').'?album_type='.$key.'\',\'_parent\')">
								...
								<div class="item">
								<div class="count_box count_graph1 position-relative overflow-hidden hand trans_eff" onClick="window.open(\''.site_url('members/album/rejected_album').'?album_type='.$key.'\',\'_parent\')">
								...
								<div class="item">
									<div class="count_box count_graph2 position-relative overflow-hidden hand trans_eff" onClick="window.open(\''.site_url('members/album/takedown_album').'?album_type='.$key.'\',\'_parent\')">
