...
$is_meta_permission = count_record('wl_download_permission',"customers_id='".$this->userId."' AND permission='1' "); 
?>
        ...
        <div class="dash_box p-4 mb-3">
          ...
          <div class="row g-3">
            ...
            <div class="col text-center">
              <?php
              if($is_meta_permission>0){
                echo '<input name="btn_sbt" type="submit" class="btn btn-purple" value="Download">';
              }else{
                echo '<p class="mt-1 text-danger fw-semibold">You don\'t have permission to download meta</p>';
              }?>
            </div>
          </div>
          <?php echo form_close();?>
