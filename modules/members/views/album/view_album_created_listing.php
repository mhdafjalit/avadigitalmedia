                  ...
                  if(is_array($res) && !empty($res)){
                    foreach ($res as $key => $val) {
                      ...
                      <tr class="pr_parent" data-release-id="<?= $val['release_id'];?>">
                        ...
                        <td class="white_space">
                          <a data-fancybox="" data-type="iframe" data-src="<?= site_url('members/release/view_release/'.md5($val['release_id']));?>" href="javascript:void(0);" class="pop2 me-2">
                            <img src="<?= theme_url();?>images/eye2.svg" width="18" decoding="async" fetchpriority="high" alt="View">
                          </a>
                          <a href="<?= site_url('members/release/new_release/'.md5($val['release_id']).'?album_type='.$val['album_type']);?>" class="me-2" title="Edit"><img src="<?= theme_url();?>images/edit.svg" width="16" decoding="async" fetchpriority="high" alt="Edit"></a>
                          <?php
                          if(!$val['release_ref_id'] >0){
                            echo '<a href="'.site_url("members/album/release_delete/".md5($val['release_id'])).'" class="me-2 confirm_delete" title="Delete">
